    ...
    <div className="App col-lg-7 col-12 mx-auto">
      ...
      <div className='d-flex flex-column mt-2'>
          <div className="d-flex justify-content-start">
                <NavLink to="/" className={({isActive}) =>isActive?'active-link NavLink py-2 px-4':'NavLink py-2 px-4'} style={({isActive}) =>{
                ...
                <NavLink to="/fileupload" className={({isActive}) =>isActive?'active-link  NavLink py-2 px-4':' NavLink py-2 px-4'} style={({isActive}) =>{
                    ...
                    }} ><svg xmlns="http://www.w3.org/2000/svg"  className='svg' width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#777" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2-2.4-3.5-4.4-3.5h-1.2c-.7-3-3.2-5.2-6.2-5.6-3-.3-5.9 1.3-7.3 4-1.2 2.5-1 6.5.5 8.8m8.7-1.6V21"/><path d="M16 16l-4-4-4 4"/></svg> بارگذاری فایل</NavLink>
                <NavLink to="/Link" className={({isActive}) =>isActive?'active-link  NavLink py-2 px-4':' NavLink py-2 px-4'} style={({isActive}) =>{
                    ...
                    }}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"className='svg' stroke='#777' viewBox="0 0 24 24" fill="none" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg> لینک</NavLink>
