        ...
        <div className="d-block ml-1 ml-lg-5 mt-4" >
            <div className="d-flex flex-column" style={{borderRadius:'35px',border:`1px solid ${GREEN}`, backgroundColor:'transparent',color:GREEN}}>
                ...
                {" "}
                 {
                    !showBtn.isHidden?
                    <svg width="24" height="24" stroke={GREEN} viewBox="0 0 24 24" fill="none" strokeWidth="1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" strokeWidth="1" viewBox="0 0 24 24" stroke={GREEN} fill="none" class="bi bi-caret-up-fill">
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={GREEN} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M10 3H6a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h4M16 17l5-5-5-5M19.8 12H9"/></svg>
                    خروج
                </button>
            </div>
        </div>
